<template>
    <div>
        ...
        <div id="sheet" class="login">
            ...
            <form action="post">
                <div class="email">
                    <p class="id"><input placeholder="Enter Email Address" type="text" v-model="mail" /></p>
                </div>
                <div class="password">
                    <p class="pass"><input placeholder="Enter Password" type="password" v-model="password" /></p>
                </div>
            </form>
        ...
        methods: {
            login(){
                    ...
                    if (this.mail == '' || this.password == '') {
                        this.errMsg = 'Mail or password is empty';
                        return;
                    }
                    ...
                    this.$axios.post(url, data)
                        ...
                        .catch((error) => {
                            ...
                            if (error.response.data &&
                                ...
                                error.response.data.code == 'LOGINPOST400') {
